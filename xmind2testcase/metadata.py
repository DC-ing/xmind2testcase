...
class TestSuite(object):
    ...
    def __init__(
        ...
        :param writer: test suite writer
...
class TestStep(object):
    ...
    def __init__(
        self, step_number=1, actions="", expectedresults="", execution_type=1, result=0
    ):
        """
        TestStep
